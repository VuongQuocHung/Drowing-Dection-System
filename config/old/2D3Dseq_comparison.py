config = {
    ...
    # FUNDAMENTAL
    'mode': '2D3Dseq', # 'reference', '2D3Dseq', '2Dseq', '3Dseq'
    'freeze_backbone_2d': False,
    'freeze_backbone_3d': False,
    'vis_thresh': 0.75, # default: 0.4
    'batch_size': 2,   # default for train.py: 16, default for eval.py: 8, maybe later need to split into ||  16!!
    ...
    # IMPORTANT
    'T_len': 16,             # not for 2Dseq
    'T_distance': 3,         # not for 2Dseq
    'S_len': 42,              # seq
    'S_distance': 3,         # 
    'sequence_distance': 30,  # seq
    'layers': 2,             # seq
    # DATA
    'fold': 3,
