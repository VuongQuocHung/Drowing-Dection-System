...
class Criterion(object):
    def __init__(self, d_cfg, args, img_size, num_classes=80, multi_hot=False):
        self.num_classes = num_classes
        self.img_size = img_size
        self.loss_conf_weight = d_cfg['loss_conf_weight']
        self.loss_cls_weight = d_cfg['loss_cls_weight']
        self.loss_reg_weight = d_cfg['loss_reg_weight']
        self.focal_loss = d_cfg['focal_loss']
        ...
        self.matcher = SimOTA(
            ...
            center_sampling_radius=d_cfg['center_sampling_radius'],
            topk_candidate=d_cfg['topk_candicate']
            )
...
def build_criterion(d_cfg, args, img_size, num_classes, multi_hot=False):
    criterion = Criterion(d_cfg, args, img_size, num_classes, multi_hot)
